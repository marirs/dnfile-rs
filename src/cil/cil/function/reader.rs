...
use super::super::super::clr::{token::Token, argument::Argument, local::Local};
use super::super::{
    enums::*,
    opcode::*};
...
impl Reader{
    ...
    pub fn is_arg_operand_instruction(&mut self, insn: &Instruction) -> bool{
        return vec![OpCodeValue::Ldarg,
                    OpCodeValue::Ldarg_S,
                    OpCodeValue::Ldarga,
                    OpCodeValue::Ldarga_S,
                    OpCodeValue::Starg,
                    OpCodeValue::Starg_S].contains(&insn.opcode.value)
    }
    ...
    pub fn read_operand(&mut self, insn: &Instruction) -> Result<Operand>{
        match insn.opcode.operand_type{
            ...
            _ => Err(crate::error::Error::UndefinedOperandType(insn.opcode.operand_type.clone()))
        }
    }
}
