...
impl Instruction{
    pub fn new() -> Self{
        Self{
            offset: 0,
            opcode: super::opcode::OpCode::new("UNKNOWN1",
    ...
    pub fn size(&self) -> usize{
        ...
        if vec![OperandType::InlineBrTarget,
                ...
                OperandType::ShortInlineR].contains(&opcode.operand_type){
            opcode.size() + 4
        } else if vec![OperandType::InlineI8,
                       OperandType::InlineR].contains(&opcode.operand_type){
           opcode.size() + 8
            ...
            opcode.size() + 2
        } else if vec![OperandType::ShortInlineBrTarget,
                       OperandType::ShortInlineI,
                       OperandType::ShortInlineVar].contains(&opcode.operand_type){
            opcode.size() + 1
        } else if vec![OperandType::InlineNone,
                       OperandType::InlinePhi].contains(&opcode.operand_type){
            opcode.size()
        } else {
            opcode.size()
        }
    ...
    pub fn is_cond_br(&self) -> bool{
        vec![OpCodeValue::Bge,
             ...
             OpCodeValue::Beq_S,
             OpCodeValue::Bne_Un,
             OpCodeValue::Bne_Un_S].contains(&self.opcode.value)
    }
    ...
    pub fn is_ldc(&self) -> bool{
        vec![OpCodeValue::Ldc_I4_M1,
             ...
             OpCodeValue::Ldc_I8,
             OpCodeValue::Ldc_R4,
             OpCodeValue::Ldc_R8].contains(&self.opcode.value)
    }
    ...
    pub fn is_ldarg(&self) -> bool{
        vec![OpCodeValue::Ldarg,
             ...
             OpCodeValue::Ldarg_S,
             OpCodeValue::Ldarga,
             OpCodeValue::Ldarga_S].contains(&self.opcode.value)
    }
    ...
    pub fn get_ldarg(&self) -> Option<Argument>{
        ...
        match &self.opcode.value{
            OpCodeValue::Ldarg | OpCodeValue::Ldarga | OpCodeValue::Ldarg_S | OpCodeValue::Ldarga_S => s,
    ...
    pub fn is_ldloc(&self) -> bool{
        vec![OpCodeValue::Ldloc,
             ...
             OpCodeValue::Ldloc_S,
             OpCodeValue::Ldloca,
             OpCodeValue::Ldloca_S].contains(&self.opcode.value)
    }
    ...
    pub fn get_ldoc(&self) -> Option<Local>{
        ...
        match self.opcode.value{
            OpCodeValue::Ldloc | OpCodeValue::Ldloc_S | OpCodeValue::Ldloca | OpCodeValue::Ldloca_S => s,
    ...
    pub fn is_stloc(&self) -> bool{
        vec![OpCodeValue::Stloc,
             OpCodeValue::Stloc_0,
             OpCodeValue::Stloc_1,
             OpCodeValue::Stloc_2,
             OpCodeValue::Stloc_3,
             OpCodeValue::Stloc_S].contains(&self.opcode.value)
    }
